<template>
  <div style="margin-top: 50px">
    <el-form
      ...
      size="small"
    >
      <el-form-item :label="$t('SEARCHING.ASSOCIATED')">
        <el-transfer
          style="display: inline-block"
          filterable
          :filter-method="filterMethod"
          :filter-placeholder="$t('SEARCHING.ASSOCIATED')"
      ...
      <el-form-item :label="$t('SEARCHING.OPTIMIZATION')">
        <el-transfer
          style="display: inline-block"
          filterable
          :filter-method="filterMethod"
          :filter-placeholder="$t('SEARCHING.OPTIMIZATION')"
      ...
      <el-form-item style="text-align: center">
        <el-button
          size="medium"
          @click="handlePrev"
        >{{$t('SEARCHING.PREVIOUSSTEP')}}</el-button>
        <el-button
          type="primary"
          size="medium"
